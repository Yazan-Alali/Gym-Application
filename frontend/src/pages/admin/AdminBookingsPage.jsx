...
export default function AdminBookingsPage() {
  ...
  return (
    <div>
      <h1 className="mb-2 text-3xl font-bold">Booking overview</h1>
          ...
          <tbody>
            ...
            {bookings.map((b) => (
              <tr key={b.id} className="border-b border-slate-100 dark:border-slate-800">
                ...
                <td className="px-4 py-3">{b.sessionTitle}</td>
                ...
                <td className="px-4 py-3">{new Date(b.bookedAt).toLocaleString()}</td>
              </tr>
            ))}
          </tbody>
        </table>
